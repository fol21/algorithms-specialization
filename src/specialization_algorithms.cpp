...
// n is size of heap
void Spec_Heapsort_v1::heapify(int arr[], int N, int i)
{
	...
	if (largest != i) {
		...
		// sub-tree
		Spec_Heapsort_v1::heapify(arr, N, largest);
	}
}

void Spec_Heapsort_v1::heapify(std::vector<int>* arr, int i)
{
    Spec_Heapsort_v1::heapify(arr->data(), arr->size(), i);
}

// Main function to do heap sort
void Spec_Heapsort_v1::heapSort(std::vector<int>* arr)
{
    Spec_Heapsort_v1::heapSort(arr->data(), arr->size());
}

void Spec_Heapsort_v1::heapSort(int arr[], int N)
{

	// Build heap (rearrange array)
	for (int i = N / 2 - 1; i >= 0; i--)
		Spec_Heapsort_v1::heapify(arr, N, i);
	...
	for (int i = N - 1; i > 0; i--) {
		...
		Spec_Heapsort_v1::heapify(arr, i, 0);
	}
}
